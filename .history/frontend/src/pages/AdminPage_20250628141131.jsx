...
const featureContent = {
  readers: <div style={{ fontSize: 16, marginTop: 16 }}>这里是读者管理功能</div>,
  books: <div style={{ fontSize: 16, marginTop: 16 }}>这里是图书管理功能</div>,
  borrowing: <div style={{ fontSize: 16, marginTop: 16 }}>这里是借还管理功能</div>,
};
