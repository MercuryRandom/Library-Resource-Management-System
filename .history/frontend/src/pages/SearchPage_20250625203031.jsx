...
const SearchPage = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', minHeight: '60vh' }}>
      <div className="card-hover" style={{ maxWidth: '900px', width: '100%', background: 'linear-gradient(90deg, #e3eafc 0%, #f5f7fb 100%)', borderRadius: '32px', boxShadow: '0 8px 48px rgba(45,108,223,0.10)', padding: '64px 60px 60px 60px', margin: '40px 0', transition: 'box-shadow 0.25s, transform 0.25s' }}>
